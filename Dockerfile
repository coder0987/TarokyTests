...
COPY ./assets/hopscotch/ /usr/share/nginx/html/assets/hopscotch/
...
COPY ./assets/rules/ /usr/share/nginx/html/assets/rules/
COPY ./assets/misc/ /usr/share/nginx/html/assets/
